                                        ...
                                        <div class="col-lg-5">
                                            <div class="imgs-zoom-area">
                                                <div>
                                                        ...
                                                        <img id="zoom_03"
                                                            src="/resources/upload/product/${dto.productImgDTO.fileName}"
                                                    ...
                                                    <div class="tab-content">
                                                        ...
                                                        <div role="tabpanel" class="tab-pane" id="reviews">
														  ...
														  <!-- Add a container to center the content -->
														  	<div class="row">
														    	<div class="col-lg-8">
		                                                            <form class="row g-3 mt-5" action="./detail" method="get"
		                                                                id="searchForm" >
		                                                                ...
		                                                                <div class="col-auto">
		                                                                    ...
		                                                                    <select class="form-select" name="kind" id="kind"
		                                                                        aria-label="Default select example" style="height : 35px; width : 100px;" >
		
		                                                                        <option value="contents" ${pager.kind
		                                                                            eq 'contents' ? 'selected' : '' }>내용
		                                                                        </option>
		                                                                ...
		                                                                <div class="col-auto">
		                                                                    ...
		                                                                    <input type="text" class="form-control"
		                                                                        ...
		                                                                        value="${pager.search}" style="margin-bottom : 3px; height : 35px;">
		                                                                </div>
		                                                                <div class="col-auto">
		                                                                    <button type="submit"
		                                                                        class="btn btn-warning mb-1" style="width : 80px; height : 35px;">검색</button>
		                                                                </div>
		                                                            </form>
                                                           		</div>
                                                           	</div>
